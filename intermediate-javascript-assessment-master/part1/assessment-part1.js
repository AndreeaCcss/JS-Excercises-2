...
charger.drive();
console.log(charger.gasRemaining)
var mustang = new Vehicle();
mustang.drive();
mustang.drive();
console.log(mustang.gasRemaining)
...
var string = " hello there world! wha's poppin=g "
console.log(string.grammarPolice())
...
// When your promise receives its results, set variable 'theAnswer' 
// (seen below) equal to the result.

var theAnswer = "Unknown";

// CODE HERE...
function promiseCatcher(foo){
